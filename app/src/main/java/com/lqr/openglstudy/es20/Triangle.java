...
public class Triangle {
    ...
    static float TRIANGLE_COORDS[] = { // in counterclockwise order:
            0.0f, 0.5f, 0.0f, // top
    ...
    // final float COLOR[] = {255, 0, 0, 1.0f};
    final float COLOR[] = {
            1.0f, 0f, 0f, 1.0f,
            0f, 1.0f, 0f, 1.0f,
            0f, 0f, 1.0f, 1.0f
    ...
    private final int mVertexCount = TRIANGLE_COORDS.length / COORDS_PER_VERTEX;
